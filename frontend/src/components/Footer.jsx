...
const Footer = () => {
  return (
    <footer className="bg-medi-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/how-it-works" className="text-gray-300 hover:text-white transition">How It Works</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex items-center space-x-2">
            ...
            <div className="bg-white px-2 py-1 rounded text-xs font-semibold text-medi-dark">
              Hedera Hashgraph
            </div>
          </div>
        </div>
